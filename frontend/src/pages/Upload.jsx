...
const Upload = ({ onAnalysisComplete, onNavigate }) => {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6" style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>
      {/* Header */}
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
      >
        <h1 className="text-3xl font-light text-gray-900 mb-2">Upload Data</h1>
        <p className="text-sm text-gray-500">Upload moderator data for analysis</p>
      </motion.div>
